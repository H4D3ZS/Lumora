...
async function exampleUsage() {
    ...
    // ============================================================================
    const repo = (0, index_1.createGitHubRepository)(client);
    // ============================================================================
    ...
    // ============================================================================
    try {
        const { content, sha } = await repo.getFileContent('username', 'my-lumora-app', 'schema.json');
    ...
    try {
        ...
        const { content: currentContent, sha } = await repo.getFileContent('username', 'my-lumora-app', 'schema.json');
        // Modify the content
    ...
    // ============================================================================
    try {
        const multiCommitResult = await repo.commitFiles('username', 'my-lumora-app', 'main', 'Initial project setup', [
            {
                path: 'README.md',
    ...
    try {
        ...
        // Create a new branch
        await repo.createBranch('username', 'my-lumora-app', 'feature/new-ui', 'main');
    ...
    // ============================================================================
    try {
        const updatedRepo = await repo.updateRepository('username', 'my-lumora-app', {
    ...
    try {
        ...
        const { sha } = await repo.getFileContent('username', 'my-lumora-app', 'old-file.txt');
        // Delete the file
        const deleteResult = await repo.deleteFile('username', 'my-lumora-app', 'old-file.txt', 'Remove old file', sha);
...
//# sourceMappingURL=github-usage.example.js.map