...
exports.GitHubReleaseManager = void 0;
exports.createGitHubReleaseManager = createGitHubReleaseManager;
...
class GitHubReleaseManager {
    ...
    async createRelease(options) {
        try {
            ...
            if (options.generateNotes) {
                body = await this.generateReleaseNotes(options.owner, options.repo, options.version, { previousVersion: this.getPreviousVersion(options.version) });
            }
     ...
     */
    async uploadBundle(owner, repo, releaseId, bundle, bundlePath) {
        ...
        try {
            ...
            const manifestData = Buffer.from(JSON.stringify(bundle.manifest, null, 2), 'utf-8');
            ...
            const checksumData = Buffer.from(`${checksum}  bundle.json\n${bundle.manifest.checksum}  manifest.json`, 'utf-8');
     ...
     */
    async generateReleaseNotes(owner, repo, version, options) {
        const sections = [];
        // Add version header
...
exports.GitHubReleaseManager = GitHubReleaseManager;
/**
 * Create a GitHub release manager
 */
function createGitHubReleaseManager(client) {
    return new GitHubReleaseManager(client);
}
//# sourceMappingURL=github-release-manager.js.map