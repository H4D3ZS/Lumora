 ...
 */
export class ProviderAdapter extends BaseStateAdapter {
   ...
   */
  private generateProviderClass(state: StateDefinition, providerName: string): string {
...
${setters}
   ...
   */
  private generateSetter(variable: StateVariable): string {
