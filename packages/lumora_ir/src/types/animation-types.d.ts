 ...
 */
export type EasingType = 'linear' | 'ease' | 'ease-in' | 'ease-out' | 'ease-in-out' | 'cubic-bezier' | 'spring' | 'bounce' | 'elastic';
/**
 * Animation state
 */
 ...
 */
export type AnimationCoordination = 'parallel' | 'sequence' | 'stagger';
/**
 ...
 */
export declare const ANIMATION_PRESETS: Record<string, AnimationPreset>;
/**
