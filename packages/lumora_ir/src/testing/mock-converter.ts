...
export class MockConverter {
   ...
   */
  private generateFlutterMockMethod(method: MockMethod): string {
   ...
   */
  private generateJestMockMethod(method: MockMethod): string {
    if (method.implementation) {
   ...
   */
  private inferFlutterReturnType(value: any): string {
