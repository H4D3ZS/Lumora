 ...
 */
export function parseJSDoc(jsdoc: string): DocComment {
 ...
 */
export function jsdocToDartdoc(jsdoc: string, sourceFramework: 'react' | 'flutter' = 'react'): string {
 ...
 * @returns Parsed documentation structure
 */
export function parseDartdoc(dartdoc: string): DocComment {
 ...
 */
export function dartdocToJSDoc(dartdoc: string, sourceFramework: 'react' | 'flutter' = 'flutter'): string {
 ...
 */
function convertTypeJSToDart(jsType: string): string {
 ...
 */
function convertTypeDartToJS(dartType: string): string {
  const typeMap: Record<string, string> = {
    'String': 'string',
    'int': 'number',
    'double': 'number',
 ...
 */
function convertReactCodeToDart(reactCode: string): string {
 ...
 */
function convertDartCodeToReact(dartCode: string): string {
 ...
 */
export function extractInlineComments(sourceCode: string): Array<{ line: number; text: string; type: 'single' | 'block' }> {
  const comments: Array<{ line: number; text: string; type: 'single' | 'block' }> = [];
