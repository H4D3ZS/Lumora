...
exports.ConversionErrorHandler = exports.ConversionFailureReason = void 0;
exports.getConversionErrorHandler = getConversionErrorHandler;
const error_handler_1 = require("./error-handler");
/**
 * Conversion failure reason
 */
var ConversionFailureReason;
(function (ConversionFailureReason) {
    ConversionFailureReason["UNSUPPORTED_FEATURE"] = "unsupported_feature";
    ConversionFailureReason["UNMAPPED_WIDGET"] = "unmapped_widget";
    ConversionFailureReason["INCOMPATIBLE_PATTERN"] = "incompatible_pattern";
    ConversionFailureReason["MISSING_DEPENDENCY"] = "missing_dependency";
    ConversionFailureReason["INVALID_IR"] = "invalid_ir";
    ConversionFailureReason["GENERATION_ERROR"] = "generation_error";
})(ConversionFailureReason || (exports.ConversionFailureReason = ConversionFailureReason = {}));
/**
...
class ConversionErrorHandler {
     ...
     */
    handleConversionFailure(details) {
        const error = {
            category: error_handler_1.ErrorCategory.CONVERSION,
            severity: error_handler_1.ErrorSeverity.ERROR,
     ...
     */
    generateConversionSuggestions(details) {
        const suggestions = [];
        switch (details.reason) {
            case ConversionFailureReason.UNSUPPORTED_FEATURE:
                suggestions.push({
     ...
     */
    getWidgetMappingExample(details) {
...
`;
     ...
     */
    getSimilarWidgetSuggestion(details) {
     ...
     */
    getAlternativeApproaches(details) {
        const alternatives = [];
     ...
     */
    formatConversionError(error) {
        return this.errorHandler.formatError(error);
    }
}
exports.ConversionErrorHandler = ConversionErrorHandler;
/**
 * Get singleton instance of ConversionErrorHandler
 */
function getConversionErrorHandler() {
