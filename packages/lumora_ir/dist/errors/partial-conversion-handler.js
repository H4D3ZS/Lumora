...
exports.PartialConversionHandler = exports.ConversionIssueSeverity = void 0;
exports.getPartialConversionHandler = getPartialConversionHandler;
/**
 * Conversion issue severity
 */
var ConversionIssueSeverity;
(function (ConversionIssueSeverity) {
    ConversionIssueSeverity["INFO"] = "info";
    ConversionIssueSeverity["WARNING"] = "warning";
    ConversionIssueSeverity["ERROR"] = "error";
})(ConversionIssueSeverity || (exports.ConversionIssueSeverity = ConversionIssueSeverity = {}));
/**
 * Partial Conversion Handler class
 */
class PartialConversionHandler {
    constructor() {
        this.issues = [];
     ...
     */
    generateTodoComment(framework, issue, originalCode) {
     ...
     */
    generateFallbackCode(framework, issue, originalCode) {
     ...
     */
    wrapWithTodoMarkers(framework, code, issue) {
        const commentStyle = framework === 'react' ? '//' : '//';
     ...
     */
    getResult(generatedCode) {
        const completionPercentage = this.totalNodes > 0
            ? Math.round((this.convertedNodes / this.totalNodes) * 100)
            : 0;
        const hasManualWork = this.issues.some(issue => issue.severity === ConversionIssueSeverity.ERROR);
        return {
     ...
     */
    generateIssueReport(result, sourceFile) {
...
exports.PartialConversionHandler = PartialConversionHandler;
/**
 * Get singleton instance of PartialConversionHandler
 */
function getPartialConversionHandler() {
