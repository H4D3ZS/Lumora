...
exports.RiverpodAdapter = void 0;
const base_adapter_1 = require("./base-adapter");
/**
 * Riverpod Adapter
 * Generates StateNotifier and Provider code for Flutter Riverpod
 */
class RiverpodAdapter extends base_adapter_1.BaseStateAdapter {
    constructor() {
        super(...arguments);
        this.name = 'riverpod';
    }
     ...
     * Generate state class
     */
    generateStateClass(state, stateClassName) {
...
${copyWithBody}
     ...
     * Generate StateNotifier class
     */
    generateNotifierClass(state, componentName, notifierName, stateClassName) {
...
${methods}
     ...
     */
    generateUpdateMethod(variable, stateClassName) {
     ...
     */
    generateProvider(notifierName, stateClassName, providerName) {
        return `
...
exports.RiverpodAdapter = RiverpodAdapter;
